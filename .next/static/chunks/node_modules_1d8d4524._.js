(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_1d8d4524._.js", {
...
"[project]/node_modules/@prismicio/client/dist/cookie.js [app-client] (ecmascript) <export * as cookie>": ((__turbopack_context__) => {
"use strict";

var { g: global, d: __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "cookie": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prismicio$2f$client$2f$dist$2f$cookie$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__)
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prismicio$2f$client$2f$dist$2f$cookie$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__cookie$3e$__ = __turbopack_context__.i("[project]/node_modules/@prismicio/client/dist/cookie.js [app-client] (ecmascript) <export * as cookie>");
        ...
        "PrismicPreviewClient.useEffect": ()=>{
            ...
            if (hasCookieForRepository && !isDraftMode) {
                ...
                globalThis.fetch(updatePreviewURL, {
                    ...
                    "PrismicPreviewClient.useEffect": (res)=>{
                ...
                }["PrismicPreviewClient.useEffect"]).catch({
                    "PrismicPreviewClient.useEffect": ()=>{}
                }["PrismicPreviewClient.useEffect"]);
            }
            ...
            function onEnd(event) {
                ...
                globalThis.fetch(exitPreviewURL, {
                    ...
                    "PrismicPreviewClient.useEffect.onEnd": (res)=>{
                        if (!res.ok) {
                ...
                }["PrismicPreviewClient.useEffect.onEnd"]).catch({
                    "PrismicPreviewClient.useEffect.onEnd": ()=>{}
                }["PrismicPreviewClient.useEffect.onEnd"]);
            }
            return ({
                "PrismicPreviewClient.useEffect": ()=>controller.abort()
            })["PrismicPreviewClient.useEffect"];
        }
    }["PrismicPreviewClient.useEffect"], [
        repositoryName,
...
function getPrismicPreviewCookie(cookieJar) {
    ...
    for (const cookie$1 of cookies){
        ...
        if (name === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prismicio$2f$client$2f$dist$2f$cookie$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__cookie$3e$__["cookie"].preview) {
...
//# sourceMappingURL=node_modules_1d8d4524._.js.map